...
import { C as attr, i as derived, r as bind_props, t as attr_class, w as escape_html } from "./server.js";
import "./forms.js";
...
function QrisModal($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		let { open = false, amount = 0, orderId = null, onPaid = void 0, onConfirm = void 0 } = $$props;
		let secondsLeft = 300;
		let pollTimer;
		let countdownTimer;
