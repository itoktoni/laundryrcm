...
const publicRoutes = ['/login', '/register', '/api/wa/webhook', '/api/telegram/webhook', '/api/telegram/setwebhook', '/api/webhook', '/api/webhook/schedule', '/api/ai', '/.well-known', '/[fallback]'];
